        ...
        if (SUPERSET_URL.substr(0, 2) !== '${') {
            reports = {
                ...
                PROOF_OF_CONCEPT: createReport('proofOfConcept',
                    'https://app.powerbi.com/view?r=eyJrIjoiZWU4NTBmNTMtNWM1OS00MmJmLTkzYTAtNGE0MTA2Y' +
                    'TdiM2YzIiwidCI6IjAwNTMxNzRhLTkxMDAtNGU4ZS05NzlhLTQ0MzZkYTAxYjBlZSIsImMiOjZ9',
                    'QUARTERLY_REQUISITION_STATUS')
            };
        }
