...
(function() {
    ...
    function RequisitionViewController($state, requisition, requisitionValidator, requisitionService,
         ...
         */
        function submitRnr() {
            // SELV3-15: warn user when ordered volume exceeds available
            var confirmMessage = vm.requisition.$toLargeOrderVolume ?
                messageService.get('requisitionView.submitWithVolumeWarn.confirm', {
                    volumeExcess: vm.requisition.$orderVolume - vm.requisition.$availableCceCapacity
                }) :
                'requisitionView.submit.confirm';
            confirmService.confirm(confirmMessage, 'requisitionView.submit.label').then(function() {
                // SELV3-15: ends here
        ...
        function authorizeRnr() {
            // SELV3-15: warn user when ordered volume exceeds available
            var confirmMessage = vm.requisition.$toLargeOrderVolume ?
                messageService.get('requisitionView.authorizeWithVolumeWarn.confirm', {
                    volumeExcess: vm.requisition.$orderVolume - vm.requisition.$availableCceCapacity
                }) :
        ...
        function approveRnr() {
            // SELV3-15: warn user when ordered volume exceeds available
            var confirmMessage = vm.requisition.$toLargeOrderVolume ?
                messageService.get('requisitionView.approveWithVolumeWarn.confirm', {
                    volumeExcess: vm.requisition.$orderVolume - vm.requisition.$availableCceCapacity
                }) :
